...
INSTALLED_APPS = [
    ...
    'apps.ext.workorderguarantee.apps.WorkorderguaranteeConfig',
    'apps.ext.workorderemergency.apps.WorkorderemergencyConfig',
    'apps.ext.tailsale.apps.TailsaleConfig',
    'apps.ext.workorderdp.apps.WorkorderdpConfig',
    ...
    'apps.crm.callcentre.apps.CallcentreConfig',
    ...
    'apps.wms.stockout.apps.StockoutConfig',
    ...
    'apps.assistants.giftintalk.apps.GiftintalkConfig',
    'apps.assistants.compensation.apps.CompensationConfig',
