# -*- coding: utf-8 -*-
# Generated by Django 1.11.16 on 2019-06-18 18:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_delete', models.BooleanField(default=False, verbose_name='删除标记')),
                ('creator', models.CharField(default='system', max_length=30, verbose_name='创建者')),
                ('good_id', models.CharField(max_length=30, unique=True, verbose_name='货品编码')),
                ('good_name', models.CharField(max_length=60, unique=True, verbose_name='货品名称')),
                ('category', models.CharField(choices=[('VAC', '吸尘器'), ('DMC', '除螨仪'), ('VAR', '智能机器人'), ('OTH', '其他')], default='OTH', max_length=10, verbose_name='货品类别')),
                ('good_attribute', models.IntegerField(choices=[(0, '整机'), (1, '配件'), (2, '礼品')], default=0, verbose_name='货品属性')),
        ...
        migrations.AlterIndexTogether(
            name='goodsinfo',
            index_together=set([('good_id', 'good_name')]),
        ),
        migrations.AlterIndexTogether(
            name='machineinfo',
