# -*- coding: utf-8 -*-
# Generated by Django 1.11.16 on 2019-03-04 16:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('handling_status', models.CharField(choices=[(0, '未审核'), (1, '已处理'), (2, '无效'), (3, '异常')], default=0, max_length=30, verbose_name='更新客户信息状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('toproduct_status', models.CharField(choices=[(0, '未审核'), (1, '已处理'), (2, '无效'), (3, '异常')], default=0, max_length=30, verbose_name='递交审核订单状态')),
            ],
            options={
                'verbose_name': '保修单',
