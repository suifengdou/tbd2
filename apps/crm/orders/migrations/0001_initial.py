    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.SmallIntegerField(choices=[(0, '已取消'), (1, '未处理'), (2, '未标记'), (3, '未财审'), (4, '已完成')], db_index=True, default=1, verbose_name='单据状态')),
                ('process_tag', models.SmallIntegerField(choices=[(0, '未处理'), (1, '待核实'), (2, '已确认'), (3, '待清理'), (4, '已处理'), (5, '驳回'), (6, '特殊订单'), (7, '手工设置成功')], default=0, verbose_name='处理标签')),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': 'CRM-UT订单-未标记',
                'proxy': True,
                'indexes': [],
            },
            bases=('orders.orderinfo',),
