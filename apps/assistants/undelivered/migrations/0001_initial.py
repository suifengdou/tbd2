# -*- coding: utf-8 -*-
# Generated by Django 1.11.16 on 2019-11-20 17:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(0, '订单取消'), (1, '等待处理'), (2, '处理完成'), (3, '特殊订单')], default=0, verbose_name='单据处理状态')),
                ('status_tag', models.SmallIntegerField(choices=[(0, '未标记'), (1, '订金订单'), (2, '时效外'), (3, '时效内'), (4, '暂不发货'), (5, '其他')], default=0, verbose_name='订单标记')),
            ],
            options={
