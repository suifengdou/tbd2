# -*- coding: utf-8 -*-
# Generated by Django 1.11.16 on 2019-06-11 14:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(0, '等待处理'), (1, '未发订金'), (2, '先不发货'), (3, '半退未发'), (4, '特别跟进'), (5, '缺货订单'), (6, '当前正常'), (7, '异常订单'), (8, '处理完成')], default=0, verbose_name='单据处理状态')),
