    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.IntegerField(choices=[(0, '小狗体系'), (1, '物流快递'), (2, '仓库存储'), (3, '生产制造'), (4, '其他类型')], default=0, verbose_name='公司类型')),
            ],
            options={
                'verbose_name': 'BASE-公司',
                'verbose_name_plural': 'BASE-公司',
